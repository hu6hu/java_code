...
//如在取钱界面取钱，则会调用此函数，进行 try/catch 处理，获得这个函数的异常，弹窗说明异常
        if (money > this.money) {
        ...
        fw.write(Test.recordString.append(dateString + "\t" + Test.currentAccount.id
...
// System.out.println(Test.file);
            ...
            fw.write(Test.recordString.append(dateString+"\t"+Test.currentAccount.id+"\t 存入" +
                    money + "元\r\n").toString());
            fw.flush();//写进文件
            fw.close();
            this.money+=money;
