...
public class Encrypt {
    public static void main(String[] args) {
        ...
        int encryptedNumber;
        digit = new int[4];
        String inputNumber = JOptionPane.showInputDialog("Enter a four digit numberr:");
        ...
        JOptionPane.showMessageDialog(null,number+"加密之后是："
                +encryptedNumber,"密文",JOptionPane.INFORMATION_MESSAGE);
       System.exit(0);
